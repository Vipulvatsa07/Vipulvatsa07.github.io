  ...
  return (
    <div className="n-wrapper" id="Navbar">
      ...
      <div className="n-left ml-2">
        <div className="n-name">Vipul Vatsa</div>
        {/* <Toggle /> */}
        {/* <p className="mt-3">
          <Toggle />
        </p> */}
      ...
      <div className="n-right">
        ...
        {/* <a target="_blank" href="https://wa.me/8791744159">
          <button className="button n-button ml-2">Contact</button>
        </a> */}
        <p className="mt-3">
          <Toggle />
        </p>
        {menu ? (
          <i onClick={navbar} class="menu fa-solid fa-xmark"></i>
        ) : (
          <i onClick={navbar} class="menu fa-solid fa-bars"></i>
        )}
      </div>
      {menu && (
